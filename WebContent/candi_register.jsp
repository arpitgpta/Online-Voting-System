...
<!-- main course -->
	<div class="row">
		...
		<div class="col-8" style="border: 2px solid black; border-radius: 10px;">
			<form action="keep_candi" method="post" >
				<h2 style="font-family: cursive; color: blue">Candidate Register</h2> <br>
				...
				<br> <br>
				<h3 style="margin-left: 80px;">Electoral Info</h3>
				<fieldset class="col-1"></fieldset>
				<fieldset style=" border:1px solid #008000; border-left: 20px solid #008000; border-radius:40px;  padding: 10px; margin-left:80px; background-color:white" class="col-10">

					<div class="row" style="margin-top:5px;">
						<div class="col-1"></div>
						<div class="col-4"><input type="text" name= "party" placeholder="Party"></div>
						<div class="col-2"></div>
						<div class="col-4"><textarea rows="5" cols="25" name="moto" placeholder="Manifesto"></textarea></div>
					</div>
				...
				<fieldset style=" border:1px solid #008000; border-right: 20px solid #008000;  border-radius:40px;  padding: 10px; margin-left:80px; background-color:white" class="col-10">
					...
					<div class="row" style="margin-top:5px;">
						<div class="col-1"></div>
						<div class="col-4">Party Symbol</div>
						<div class="col-1"></div>
						<div class="col-4"><input type="file" name="img_symbol"></div>
					</div>
